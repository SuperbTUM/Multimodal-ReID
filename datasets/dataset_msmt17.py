...
class MSMT17V1(BaseImageDataset):
    """
    MSMT17
    ...
    def __init__(self, root='', verbose=True, pid_begin=0, **kwargs):
        ...
        self._check_before_run()
        train = self._process_dir(self.train_dir, True)
        query = self._process_dir(self.test_dir)
    ...
    def _process_dir(self, dir_path, relabel=False):
        ...
        for img_idx, img_path in enumerate(img_paths):
            ...
            if relabel:
                pid = pid2label[pid]
            dataset.append((img_path, pid, camid, 0, img_idx))
